                    ...
                    ?>
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    <a href="edit_paket.php?id_paket=<?= $data['id_paket'] ?>&&aksi=update_paket " class=" btn btn-success"> Edit </a>
                                    <a href="proses.php?id_paket=<?= $data['id_paket'] ?>&&aksi=hapus_paket " class=" btn btn-danger"> Hapus </a>
