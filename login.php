...
<body>
    <form class="form-signin" method="POST" action="cek.php">
        <div class="text-center mb-4 ">
            <img class="mb-4 rounded-circle" src="img/BMW.jpg" class="" alt="" width="180" height="180" data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="300" data-aos-offset="0" data-aos-duration="800" />
            <h1 class="h3 mb-3 font-weight-normal" data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="300" data-aos-offset="0" data-aos-duration="800">Login Admin</h1>
            <p data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="300" data-aos-offset="0" data-aos-duration="800">Form Pencucian Mobil</p>
        </div>
